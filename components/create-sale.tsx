...
const formSchema = z.object({
  ...
  liquidityPercentage: z.string().refine((val) => {
...
export function CreateSaleComponent() {
      ...
      <Card className="border-t-4 border-t-primary">
        <CardHeader>
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-3xl font-bold">Create Your Token Sale</CardTitle>
          </div>
          <CardDescription>
            Fill in the details below to set up your token sale on OctaSwap Launchpad.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="OctaSwap Token Presale" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="1 BNB = 10000 OCTA" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Percentage of raised funds that will be added as liquidity. Must be greater than 60%.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
